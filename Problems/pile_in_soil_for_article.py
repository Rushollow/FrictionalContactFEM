...
# nodes for soil ME 3 right left bot
for node_num in range(4):
    nodes.add_node(nodes[node_num].x, nodes[node_num].y - area_height)
# nodes for soil ME 2 right bot
for node_num in range(4):
    nodes.add_node(nodes[node_num].x + area_width/2, nodes[node_num].y - area_height)
